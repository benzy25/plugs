...
register_activation_hook( __FILE__, 'benz_create_update_table' );

//plugin deactivation hook (NOT the same as plugin uninstall!)
register_deactivation_hook( __FILE__, 'benz_deactivate' );

//hook when showing a post
add_filter( 'the_content', 'benz_save_hit');

/**
 * Create custom tables
 * @global type $wpdb
 */
function benz_create_update_table() {
    global $wpdb;
 ...
 * save hit on post
 */
function benz_save_hit($content) {
